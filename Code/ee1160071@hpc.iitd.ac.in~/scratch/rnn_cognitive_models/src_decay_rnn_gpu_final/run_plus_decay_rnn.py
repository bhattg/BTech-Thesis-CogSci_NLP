...
pvn.pipeline(train=True,batched=True,learning_rate=0.02,model="decay_fullGram.pkl",load_data=True,epochs=40, model_prefix='decay_fullGram', data_name='fullGram',load=False, test_size=7000)
