...
#root = "C:\\Users\\LENOVO\\Dropbox\\BTP_Gantavya_Hritik\\experiments\\Raw_Results\\FULL GRAMAR\\CNN_LATEST_WITH_SAVED_BANSAL_DATA\\logs"
#root = "D:\\Semester_7\\BTP\\src_decay_rnn_half_gram_plus\\logs"
root="C:\\Users\\LENOVO\\Dropbox\\BTP_Gantavya_Hritik\\experiments\\Raw_Results\\decay_rnn_changing alpha\\0.1\\logs"
...
def accuracy_plots_intervening_nouns(root,includeIntNoun=False):
	...
	if(includeIntNoun):
		...
		plt.ylabel("Accuracy")
		plt.title("Accuracy of CNN with number of intervening nouns with 2L test set")
...
def alpha_plot(root):
	...
	plt.title("Alpha Value with time Decay_RNN(initial alpha=0.1)")
	plt.show()
